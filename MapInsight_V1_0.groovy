    ...
    def panel = swing.panel{
        vbox {
            vbox{
                ...
                label(text: '          eg word1,word2,word3 or a single phrase in double quotes eg "united kingdom"')
...
def connectorUI(newNode) {
    ...
    c.findAllDepthFirst().each {
        ...
        if (currentNodeID != candidatenode.nodeID) {
            ...
            candidatenodewords=[]
            if (usePhrase) {
                // if only searching for a Phrase strip lead and trail double quote
